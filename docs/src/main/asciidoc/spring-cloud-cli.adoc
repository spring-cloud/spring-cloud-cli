...
----
$ spring cloud eureka configserver h2 kafka stubrunner
----
...
IMPORTANT: With 2.0.0 the Zipkin support got removed in favour of using the
Zipkin's far jar. Read more about this in the https://github.com/openzipkin/zipkin#quick-start[Zipkin's documenation].
...
----
$ spring cloud --list
source sink configserver dataflow eureka h2 hystrixdashboard kafka stubrunner
----
